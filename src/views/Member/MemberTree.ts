...
export const student: {figPath:string, firstName:string, lastName:string, grade: string, keywards:string, from:string, hobby:string, journal?:string[]}[] = [
    {
      ...
      journal: 
      [
        "村上颯一朗, 大山雄己 (2022) マルチモーダル均衡配分モデルに基づく歩行者専用道路の最適配置計画 -川越市街地における歩行者街路網の創出を例として-. 都市計画論文集 57(3): 622-629.",
    ...
    },
    {
      ...
      journal: 
      [
        "松村健太, 大山雄己 (2022) 決済方式の違いに着目した容量制約付きMaaSの効率性分析. 都市計画論文集 57(3): 666-673.",
