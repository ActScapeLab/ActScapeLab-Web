  ...
  <div class="q-pa-md">
    <div class="q-gutter-md">
      ...
      <div class="q-my-md">
        ...
        同時にEuroTechPostdoc Programmeのフェローシップを受け，EPFL/TUMで都市空間の最適化研究に取り組む．2019年10月より東京大学先端科学技術研究センターにて，
        物流の配送需要マネジメントの研究を行い，2020年4月より現職．
      </div>
    </div>
  </div>
</template>
